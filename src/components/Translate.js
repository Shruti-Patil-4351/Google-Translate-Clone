...
const API_URLS = {
  languages: 'https://translate.terraprint.co/languages',
  translate: 'https://translate.terraprint.co/translate'
};
...
export default function Translate() {
  ...
  return (
    <div className="app-header">
      <h2 className="header">Shruti's Translator</h2>
      <Form>
        <Form.Field
          control={TextArea}
